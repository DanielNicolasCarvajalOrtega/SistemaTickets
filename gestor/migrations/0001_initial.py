# Generated by Django 5.1.3 on 2024-11-28 02:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_tecnico', models.ForeignKey(limit_choices_to={'es_tecnico': True}, on_delete=django.db.models.deletion.CASCADE, to='gestor.usuario')),
            ],
        ),
        migrations.AddField(
            model_name='ticket',
